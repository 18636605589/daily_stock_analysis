...
| A-Stock 荐股集成 | 对接 a_stock 量化选股引擎（v3 契约），在 Web 页面集中展示**今日荐股、盘前复盘、历史荐股、因子 IC 追踪、绩效统计**（5个 Tab），含 shortlist/精选可操作口径与净收益统计；详见 [docs/a-stock-integration.md](docs/a-stock-integration.md) |
